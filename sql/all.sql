...
SELECT * FROM ITEM WHERE 1 = 1 ORDER BY IDATE DESC LIMIT 0,20
SELECT * FROM ITEM WHERE LOCATE('산책',INAME) LIMIT 0,20
SELECT * FROM ITEM;
SELECT * FROM ITEM WHERE 1 = 1 ORDER BY IDATE DESC LIMIT 0,20
DROP TABLE ITEM;
select * from item;
SELECT AVG(STAR) FROM REVIEW WHERE IID=1;
...
insert into review(iid,mid,writer,content,star,rimg) values(1,'admin','보노보노','상품평',4.0,'images/강아지1.PNG');
update review set rimg='images/poketmon.png' where iid=1;
select*from review;
